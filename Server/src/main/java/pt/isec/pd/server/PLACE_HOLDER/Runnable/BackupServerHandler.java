...
import pt.isec.pd.sharedLib.database.DatabaseSyncManager;

import java.io.*;
import java.net.Socket;
import java.net.SocketException;

import static pt.isec.pd.sharedLib.network.Heartbeat.BUFFER_SIZE;
import static pt.isec.pd.sharedLib.terminal.utils.printProgress;
